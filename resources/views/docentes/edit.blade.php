...
@section('content')
    <div class="container">
        <div class="row mt-5">
            <div class="col">
                <h1 class="text-uppercase">Actualizar de docente</h1>
                <hr class="my-4">
                <p class="font-weight-normal mt-2 mb-2">Actualiza los datos del docente.<br>
                    <br><b>A tener en consideración:</b><br>
                </p>
                <ul>
                    <li>El campo correo electrónico no se podrá actualizar, este campo es vital para el acceso al sistema y el envió de notificaciones del usuario
                    ...
                    <li>Se notificará por correo electrónico al usuario <b>{{$user->email}}</b> las actualizaciones que se realicen en este formulario.</li>
                </ul>
        ...
        <div class="row mt-0">
            <div class="col">
                <form action="{{url('/docentes/'.$docente->id)}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-1">
                            <label for="validationCustom02"><br>Estado de docente</label>
                    ...
                    <button class="btn btn-secondary my-5" type="submit" id="crear_docente">Actualizar docente</button>
                </form>
            </div>
        </div>
        <hr>
                            ...
                            $.ajax({
                                ...
                                complete:function(response){
                                    ...
                                    if( response.responseText == ''){
                                        ...
                                        form.reset();
                                        window.location.replace(window.location.protocol+'//'+window.location.hostname+'/docentes/'+_id+'/edit');
                                    }else{
