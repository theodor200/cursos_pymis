...
class DocentesValidateRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return[
            ...
            'apellidos' => '',
            'estado.required' =>'Ingrese el :attribute.',
            'password.required' =>'Ingrese una contraseña.',
            'password.min' =>'Ingrese una con 8 caracteres como mínimo.',
